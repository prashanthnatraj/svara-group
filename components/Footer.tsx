    ...
    <footer className="bg-svara-black py-24 px-6 border-t border-svara-gold/5">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-16 mb-20">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-12 md:gap-24">
            ...
            <div className="space-y-4 col-span-2 md:col-span-1">
              <h4 className="text-[10px] uppercase tracking-widest text-svara-gold font-bold">Connect</h4>
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 flex items-center justify-center border border-svara-white/10 text-svara-white/40 hover:border-svara-gold hover:text-svara-gold transition-all" aria-label="LinkedIn">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </a>
                <a href="#" className="w-10 h-10 flex items-center justify-center border border-svara-white/10 text-svara-white/40 hover:border-svara-gold hover:text-svara-gold transition-all" aria-label="X (Twitter)">
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </a>
                <a href="#" className="w-10 h-10 flex items-center justify-center border border-svara-white/10 text-svara-white/40 hover:border-svara-gold hover:text-svara-gold transition-all" aria-label="Instagram">
        ...
        <div className="pt-12 border-t border-svara-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[10px] uppercase tracking-[0.2em] text-svara-white/20">
            © 2026 SVARA INC. Orchestrating excellence since 2019.
          </p>
          <div className="flex gap-8 text-[9px] uppercase tracking-[0.3em] text-svara-white/20">
